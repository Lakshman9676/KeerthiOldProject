...
"otNodeNamespace\">              <Value xsi:type=\"xsd:string\">http://Inchcape.YourISS.Integration.Data"+
"Loy.PortCallSchedule.DataLoyInput</Value>            </Property>          </Properties>          <Ca"+
"chedDisplayName>JSON decoder</CachedDisplayName>          <CachedIsManaged>true</CachedIsManaged>   "+
"     </Component>      </Components>    </Stage>    <Stage>      <PolicyFileStage _locAttrData=\"Name"+
"\" _locID=\"2\" Name=\"Disassemble\" minOccurs=\"0\" maxOccurs=\"-1\" execMethod=\"FirstMatch\" stageId=\"9d0e41"+
"05-4cce-4536-83fa-4a5040674ad6\" />      <Components>        <Component>          <Name>Microsoft.Biz"+
"Talk.Component.XmlDasmComp,Microsoft.BizTalk.Pipeline.Components, Version=3.0.1.0, Culture=neutral, "+
...
"<Properties>            <Property Name=\"EnvelopeSpecNames\">              <Value xsi:type=\"xsd:string"+
"\" />            </Property>            <Property Name=\"EnvelopeSpecTargetNamespaces\">              <"+
"Value xsi:type=\"xsd:string\" />            </Property>            <Property Name=\"DocumentSpecNames\">"+
"              <Value xsi:type=\"xsd:string\" />            </Property>            <Property Name=\"Docu"+
"mentSpecTargetNamespaces\">              <Value xsi:type=\"xsd:string\" />            </Property>      "+
"      <Property Name=\"AllowUnrecognizedMessage\">              <Value xsi:type=\"xsd:boolean\">false</V"+
"alue>            </Property>            <Property Name=\"ValidateDocument\">              <Value xsi:t"+
"ype=\"xsd:boolean\">false</Value>            </Property>            <Property Name=\"RecoverableInterch"+
"angeProcessing\">              <Value xsi:type=\"xsd:boolean\">false</Value>            </Property>    "+
"        <Property Name=\"HiddenProperties\">              <Value xsi:type=\"xsd:string\">EnvelopeSpecTar"+
"getNamespaces,DocumentSpecTargetNamespaces</Value>            </Property>          </Properties>    "+
"      <CachedDisplayName>XML disassembler</CachedDisplayName>          <CachedIsManaged>true</Cached"+
...
"nt>";
        ...
        private const string _versionDependentGuid = "968fe198-ae7d-4d31-b803-aa4d8ad419e7";
...
"  <Value xsi:type=\"xsd:string\">http://Inchcape.YourISS.Integration.DataLoy.PortCallSchedule.DataLoyI"+
"nput</Value>    </Property>  </Properties></PropertyBag>";
